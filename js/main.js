...
(function () {
   ...
   * 現時点ではミンティーズ本体の連絡先を暫定利用。
   * 身体能力チェック専用の受付窓口ができた場合はここを差し替えてください。
   * -------------------------------------------------------------------- */
  var CONFIG = {
    TEL: "0566-77-7772",
    LINE_URL: "https://line.me/ti/p/@luy1644d",
    FORM_URL: "https://gym.mintea.jp/contact/", // TODO: 「身体能力チェック」専用フォームができたら差し替え
  };
   ...
   * 最重要CVは「身体能力チェック」の申込（data-cta の値で識別）。
   * -------------------------------------------------------------------- */
